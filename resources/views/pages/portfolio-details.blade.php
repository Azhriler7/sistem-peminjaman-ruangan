...
<head>
  ...
  <title>Details Ruangan - SIJARU UNTIRTA</title>
  ...
  <header id="header" class="header sticky-top">
    ...
    <div class="topbar d-flex align-items-center">
      <div class="container d-flex justify-content-center justify-content-md-between">
        <div class="contact-info d-flex align-items-center">
          <i class="bi bi-envelope d-flex align-items-center"><a href="mailto:contact@example.com">pusdainfo@untirta.ac.id</a></i>
    ...
    <div class="branding d-flex align-items-cente">
      ...
      <div class="container position-relative d-flex align-items-center justify-content-between">
        <a href="akun-user" class="logo d-flex align-items-center">
        ...
        <nav id="navmenu" class="navmenu">
          <ul>
            ...
            <li><a href="#services">Status Ruangan</a></li>
      ...
      <div class="container d-lg-flex justify-content-between align-items-center">
        ...
        <nav class="breadcrumbs">
          <ol>
            ...
            <li class="current">Detail Ruangan</li>
          </ol>
        </nav>
      </div>
    </div><!-- End Page Title -->

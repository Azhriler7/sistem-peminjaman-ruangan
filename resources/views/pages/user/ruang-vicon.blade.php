...
<head>
  ...
  <title>Detail Ruangan - VICON</title>
        ...
        <div class="row gy-4">
            ...
            <div class="portfolio-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
                <div class="swiper-slide">
                  <img src="{{ asset('assets/img/ruangan/vicon.jpg') }}" class="img-fluid" alt="Aula Fakultas Teknik">
                </div>
              </div>
          ...
          <div class="col-lg-4">
            ...
            <div class="portfolio-info" data-aos="fade-up" data-aos-delay="200">
              ...
              <ul>
                <li><strong>Nama Ruangan:</strong> Ruang VICON </li>
                <li><strong>Gedung:</strong> Gedung Dekanat Fakultas Teknik</li>
                <li><strong>Kapasitas:</strong> Sekitar 45 orang</li>
                <li><strong>Fasilitas:</strong> Layar LED, Kamera Video Conference, Microphone, Sound System, AC, Meja Meeting</li>
                <li><strong>Deskripsi Ruangan:</strong> Ruang VICON digunakan untuk kegiatan seminar hybrid, kelas, rapat organisasi dan rapat dengan pihak eksternal.</li>
              </ul>
            </div>

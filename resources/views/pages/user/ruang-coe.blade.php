...
<head>
  ...
  <title>Detail Ruangan - CoE</title>
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4">
            ...
            <div class="portfolio-info" data-aos="fade-up" data-aos-delay="200">
              ...
              <ul>
                <li><strong>Nama Ruangan:</strong> Ruang Kelas CoE</li>
                <li><strong>Gedung:</strong> Gedung CoE </li>
                <li><strong>Kapasitas:</strong> Sekitar 45 orang</li>
                <li><strong>Fasilitas:</strong> Proyektor, TV, AC, Meja dan Kursi Kelas</li>
                <li><strong>Deskripsi Ruangan:</strong> Ruang Kelas CoE digunakan untuk kegiatan perkuliahan, seminar hybrid, rapat organisasi, dan rapat dengan pihak eksternal.</li>
              </ul>
            </div>

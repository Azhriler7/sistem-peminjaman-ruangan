...
<head>
  ...
  <title>Detail Ruangan - Aula Dekanat</title>
      ...
      <div class="container d-lg-flex justify-content-between align-items-center">
        ...
        <nav class="breadcrumbs">
          <ol>
            ...
            <li class="current">Aula Dekanat</li>
          </ol>
        </nav>
      </div>
    </div>
        ...
        <div class="row gy-4">
            ...
            <div class="portfolio-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
                <div class="swiper-slide">
                  <img src="{{ asset('assets/img/ruangan/dekanat.jpg') }}" class="img-fluid" alt="Aula Fakultas Teknik">
                </div>
              </div>
          ...
          <div class="col-lg-4">
            ...
            <div class="portfolio-info" data-aos="fade-up" data-aos-delay="200">
              ...
              <ul>
                <li><strong>Nama Ruangan:</strong> Aula Dekanat </li>
                <li><strong>Gedung:</strong> Gedung Dekanat </li>
                <li><strong>Kapasitas:</strong> Sekitar 50 orang</li>
                <li><strong>Fasilitas:</strong> Proyektor, Mic, Sound System, AC, Kursi, Meja</li>
                <li><strong>Deskripsi Ruangan:</strong> Aula ini digunakan untuk kegiatan rapat, seminar kecil, sidang, dan pelatihan internal fakultas. </li>
              </ul>
            </div>
